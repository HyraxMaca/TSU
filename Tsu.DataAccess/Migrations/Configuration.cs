namespace Tsu.DataAccess.Migrations
{
	...
	internal sealed class Configuration : DbMigrationsConfiguration<Tsu.DataAccess.Concrete.TsuContext>
	{
		...
		protected override void Seed(Tsu.DataAccess.Concrete.TsuContext context)
		{
